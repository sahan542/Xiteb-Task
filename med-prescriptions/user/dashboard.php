...
$mysqli = db();
$stmt = $mysqli->prepare('
  SELECT p.*, (SELECT COUNT(*) FROM prescription_images pi WHERE pi.prescription_id = p.id) AS img_count
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <div class="d-flex align-items-center">
        ...
        <a href="<?= e(BASE_URL) ?>/user/prescription_new.php" class="btn btn-primary btn-sm me-2">+ New Prescription</a>
